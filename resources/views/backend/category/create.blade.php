              ...
              <form action="{{route('category.store')}}" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('category_name') is invalid @enderror" id="category_name" name="category_name" value="{{old('category_name')}}" placeholder="Enter Your Category Name">
                    @error('category_name')
